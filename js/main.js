...
//  !!!  安全警告  !!!
//  请勿将真实的 API 密钥直接硬编码在前端代码中，特别是要部署到公共 GitHub Pages 的项目！
//  这样做会将你的 API 密钥暴露给所有人。
//  
//  正确的做法是使用后端代理来处理 API 请求，或者使用更安全的方式来管理和使用 API 密钥。
//  例如，对于生产环境，你应该考虑使用服务器端来转发 API 请求，或者使用云函数等后端服务。
//  
//  这里为了演示方便，暂时保留了硬编码的方式，**请务必替换为更安全的方案在实际项目中使用**。
//
